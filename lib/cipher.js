...
module.exports = {
   ...
   * @param hostData {{ host: string, port: number, protocols: any[], servername?: string }}
   * @return {promise}
   */
 ...
 * @param options {{ host: string, port: number, secureProtocol: any, protocolCommonName; ciphers?: string, servername?: string }}
 * @returns {promise}
 * @private
 */
