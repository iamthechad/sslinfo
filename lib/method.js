...
module.exports = {
   ...
   * @param hostData {{ host: string, port: number, servername?: string, rejectUnauthorized?: boolean, minDHSize?: number, protocol?: { name: string, commonName: string } }}
   * @return {promise}
   */
   ...
   * @param options {{ host: string, port: number, servername?: string, rejectUnauthorized?: boolean, minDHSize?: number, protocol?: { name: string, commonName: string } }}
   * @returns {promise}
   */
